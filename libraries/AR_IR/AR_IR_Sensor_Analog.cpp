...
{
    float pin_1_reading, pin_2_reading;
    if(_IR_pin_analog_source_1->set_pin(_val.param._ir_1_pin_num) && _IR_pin_analog_source_2->set_pin(_val.param._ir_2_pin_num))
    {
            pin_1_reading = _IR_pin_analog_source_1->voltage_average();
            pin_2_reading = _IR_pin_analog_source_2->voltage_average();
